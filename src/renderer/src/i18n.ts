...
const nb = {
  ...
  'side.exportMdTip': 'Markdown-fil — ren tekst, rett inn i notatappen',
  'side.exportHtmlTip': 'Nettside — åpnes i nettleseren, beholder farger',
  'side.exportDocxTip': 'Word-dokument — til videre skriving',
  'side.exportMarginTip': 'Hele dokumentet som ny PDF, med kommentarene trykt i margen ved siden av siden de hører til',
  'side.searchAnnots': 'Søk i merknader …',
  'side.filterOn': 'Filtrer på {name} (flere kan være på samtidig)',
  ...
  'ai.providerCompat': 'Egendefinert (OpenAI-kompatibel)',
  'ai.localTag': 'lokal',
  'ai.apiKey': 'API-nøkkel',
  'ai.keySaved': '•••••••• (lagret)',
  'ai.keyNew': 'Lim inn nøkkelen din',
  'ai.keyOptional': 'Valgfri — lokale servere trenger ingen',
  'ai.keyLocalTip':
    'Ollama og LM Studio på din egen maskin trenger ingen nøkkel. Fyll bare inn hvis serveren står bak noe som krever token — en proxy, en delt server, en tjeneste i nettverket.',
  'ai.hideEmpty': 'Skjul tomme',
  'ai.stateReady': 'Klar',
  'ai.stateOff': 'Ikke satt opp',
  'ai.stateRunning': 'Kjører — velg modell',
  'ai.localHint':
    'Kjører på din egen maskin, uten nøkkel. Adressen er fylt ut på forhånd — endre den bare hvis serveren kjører på en annen port eller maskin.',
  'ai.baseUrl': 'Base-URL',
  'ai.compatModelId': 'Modell-id',
  'ai.compatModelHint': 'f.eks. llama3.1 eller mistral-large-latest',
  'ai.compatHint':
    'Alle andre OpenAI-kompatible endepunkter: vLLM, llama.cpp, en gateway på jobben. Modellisten hentes fra adressen når du lagrer.',
  'ai.modelFilter': 'Filtrer modeller …',
  'ai.ollamaDetected': 'Ollama svarer på denne maskinen — skriv inn modellen du vil bruke.',
  'ai.noVisionTip': 'Valgt modell ({model}) kan ikke lese bilder',
  'ai.keyCapHint': 'Sett et utgiftstak hos leverandøren — bare de kan stoppe forbruket.',
  'ai.keyConsoleHint': 'Lag nøkkel:',
  'ai.model': 'Modell',
...
const en: Dict = {
  ...
  'side.exportMdTip': 'Markdown file — plain text, straight into your notes app',
  'side.exportHtmlTip': 'Web page — opens in the browser, keeps the colours',
  'side.exportDocxTip': 'Word document — for writing on from here',
  'side.exportMarginTip': 'The whole document as a new PDF, with the comments printed in the margin beside the page they belong to',
  'side.searchAnnots': 'Search annotations …',
  'side.filterOn': 'Filter on {name} (several can be on at once)',
  ...
  'ai.providerCompat': 'Custom (OpenAI-compatible)',
  'ai.localTag': 'local',
  'ai.apiKey': 'API key',
  'ai.keySaved': '•••••••• (saved)',
  'ai.keyNew': 'Paste your key',
  'ai.keyOptional': 'Optional — local servers need none',
  'ai.keyLocalTip':
    'Ollama and LM Studio on your own machine need no key. Fill this in only if the server sits behind something that wants a token — a proxy, a shared server, a service on the network.',
  'ai.hideEmpty': 'Hide empty',
  'ai.stateReady': 'Ready',
  'ai.stateOff': 'Not set up',
  'ai.stateRunning': 'Running — pick a model',
  'ai.localHint':
    'Runs on your own machine, no key needed. The address is prefilled — change it only if the server runs on another port or machine.',
  'ai.baseUrl': 'Base URL',
  'ai.compatModelId': 'Model id',
  'ai.compatModelHint': 'e.g. llama3.1 or mistral-large-latest',
  'ai.compatHint':
    'Any other OpenAI-compatible endpoint: vLLM, llama.cpp, a gateway at work. The model list is fetched from the address when you save.',
  'ai.modelFilter': 'Filter models …',
  'ai.ollamaDetected': 'Ollama is answering on this machine — type the model you want to use.',
  'ai.noVisionTip': 'The selected model ({model}) cannot read images',
  'ai.keyCapHint': 'Set a spending cap with your provider — only they can stop the spending.',
  'ai.keyConsoleHint': 'Create a key:',
  'ai.model': 'Model',
