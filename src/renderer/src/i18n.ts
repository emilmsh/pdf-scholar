...
const nb = {
  ...
  'tb.hideAnnotsTip': 'Skjul merknader — vis siden uten markeringer og notater',
  'tb.showAnnotsTip': 'Vis merknader igjen',
  'tb.pen': 'Penn',
  'tb.marker': 'Tusj',
  'tb.shapes': 'Former',
  'tb.width': 'Bredde',
...
const en: Dict = {
  ...
  'tb.hideAnnotsTip': 'Hide annotations — show the page without markup and notes',
  'tb.showAnnotsTip': 'Show annotations again',
  'tb.pen': 'Pen',
