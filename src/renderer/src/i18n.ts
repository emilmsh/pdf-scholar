...
const nb = {
  ...
  'tb.fitWidthTip': 'Tilpass bredde (W)',
  'tb.fitPageTip': 'Vis hele siden i vinduet (W)',
  ...
  'tb.rotateCw': 'Roter siden (Shift+R / ] — [ mot klokken)',
...
const en: Dict = {
  ...
  'tb.fitWidthTip': 'Fit width (W)',
  'tb.fitPageTip': 'Fit whole page in window (W)',
  ...
  'tb.rotateCw': 'Rotate page (Shift+R / ] — [ counter-clockwise)',
