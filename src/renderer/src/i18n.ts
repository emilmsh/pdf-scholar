...
const nb = {
  ...
  'tb.spreadSplitTip': 'Slås av mens visningen er delt, og kommer tilbake når dokumentet vises alene',
  ...
  'menu.grabImage': 'Kopier bilde …',
  'menu.grabImageTip':
    'Dra en firkant rundt en figur, tabell eller formel – eller klikk rett på et bilde – og kopier eller lagre det som PNG',
  'imgExport.hint':
    'Dra en firkant rundt det som skal bli bilde, eller klikk på et av bildene siden inneholder · Esc avbryter',
  'imgExport.size': '{w} × {h} px',
  'imgExport.native': 'bildets egen oppløsning',
  'imgExport.rendered': 'gjengitt i {dpi} dpi',
  'imgExport.copy': 'Kopier',
  'imgExport.save': 'Lagre …',
  'imgExport.redo': 'Marker på nytt',
  'imgExport.redoTip': 'Tegn en ny firkant – dette utsnittet forsvinner',
  'imgExport.copied': 'Bildet er kopiert · {w} × {h} px',
  'imgExport.copyFailed': 'Fikk ikke lagt bildet på utklippstavla. Prøv «Lagre …» i stedet.',
  'imgExport.failed': 'Kunne ikke lage bilde av dette området.',
  'imgExport.saved': 'Bildet er lagret: {path}',
  // Filnavnet: «Attention Is All You Need - bilde s. 6.png»
  'imgExport.suffix': 'bilde s. {page}',
...
const en: Dict = {
  ...
  'tb.spreadSplitTip': 'Off while the view is split; back when the document is shown on its own',
  ...
  'menu.grabImageTip':
    'Drag a box around a figure, table or equation — or click straight on an image — and copy or save it as PNG',
  'imgExport.hint':
    'Drag a box around what should become an image, or click one of the pictures on the page · Esc cancels',
  'imgExport.size': '{w} × {h} px',
  'imgExport.native': "the image's own resolution",
  'imgExport.rendered': 'rendered at {dpi} dpi',
  'imgExport.copy': 'Copy',
  'imgExport.save': 'Save …',
  'imgExport.redo': 'Draw again',
  'imgExport.redoTip': 'Draw a new box — this capture goes away',
  'imgExport.copied': 'Image copied · {w} × {h} px',
  'imgExport.copyFailed': 'Could not put the image on the clipboard. Try “Save …” instead.',
  'imgExport.failed': 'Could not make an image of that area.',
  'imgExport.saved': 'Image saved: {path}',
  'imgExport.suffix': 'image p. {page}',
