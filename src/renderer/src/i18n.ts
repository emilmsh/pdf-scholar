...
const nb = {
  ...
  'engine.annot-hand-empty': 'den håndskrevne merknaden er tom',
  'engine.annot-hand-failed': 'fikk ikke skrevet den håndskrevne merknaden inn i filen',
  ...
  'tb.textFont': 'Skrift',
  'tb.textFontSans': 'Trykt',
  'tb.textFontSansHint': 'En vanlig tekstboks på siden',
  'tb.textFontHand': 'Håndskrift',
  'tb.textFontHandHint': 'Som en rettepenn i margen',
...
const en: Dict = {
  ...
  'engine.annot-hand-empty': 'the handwritten note is empty',
  'engine.annot-hand-failed': 'the handwritten note could not be written into the file',
  ...
  'tb.textFontSans': 'Printed',
  'tb.textFontSansHint': 'An ordinary text box on the page',
  'tb.textFontHand': 'Handwriting',
  'tb.textFontHandHint': 'Like a red pen in the margin',
