...
const nb = {
  ...
  'tb.fitPageTip': 'Tilpass hel side (W)',
  'tb.zoomExactTip': 'Skriv inn nøyaktig zoom',
  'tb.zoomMenuTip': 'Zoom-valg',
  'tb.actualSize': 'Faktisk størrelse',
  'tb.fitWidth': 'Tilpass bredde',
  'tb.fitHeight': 'Tilpass høyde',
  'tb.fitPage': 'Tilpass hel side',
  'tb.customZoom': 'Egendefinert',
  ...
  'tb.revealTip': 'Vis verktøylinjen',
...
const en: Dict = {
  ...
  'tb.fitPageTip': 'Fit whole page (W)',
  'tb.zoomExactTip': 'Enter exact zoom',
  'tb.zoomMenuTip': 'Zoom options',
  'tb.actualSize': 'Actual size',
  'tb.fitWidth': 'Fit width',
  'tb.fitHeight': 'Fit height',
  'tb.fitPage': 'Fit whole page',
  'tb.customZoom': 'Custom',
